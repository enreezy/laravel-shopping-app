<!--Footer-->
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: <?php echo json_encode($itemDataset); ?>,
                datasets: [{
                    label: '# of Quantity',
                    data: <?php echo json_encode($quantityDataset); ?>,
                    backgroundColor: <?php echo json_encode($bgcolorDataset); ?>,
                    borderColor: <?php echo json_encode($bgcolorDataset); ?>,
                    borderWidth: 1
                }]
            },
            options: {
                ...
                datasets: [
                    {
                        data: <?php echo json_encode($quantityDataset); ?>,
                        backgroundColor: <?php echo json_encode($bgcolorDataset); ?>,
                        hoverBackgroundColor: <?php echo json_encode($bgcolorDataset); ?>
                    }
                ]
            },
            options: {
